    ...
    model(0)
{
    ...
    connect(ui->createWalletButton, SIGNAL(clicked()), this, SLOT(createWallets()));
}
...
void PaperWalletDialog::createWallets() {
    QPixmap wallet;
    wallet.load(":images/paperwallets/100_reverse");
    QPainter painter(&wallet);
